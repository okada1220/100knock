...
def main():
    ...
    # accuracy(train): 0.55
    # loss(train): tensor(1.0968, grad_fn=<DivBackward0>)
    # accuracy(train): 0.749
    # loss(train): tensor(0.7225, grad_fn=<DivBackward0>)
    # accuracy(train): 0.885
    # loss(train): tensor(0.3459, grad_fn=<DivBackward0>)

    # mini-test.feature.txtでのテスト結果（500文）
    # accuracy(test): 0.722
    # loss(test): tensor(0.8551, grad_fn=<DivBackward0>)
